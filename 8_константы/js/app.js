...
//Zadacha 1 Что выведется в результате выполнения следующего кода:
// const arr = ['a', 'b', 'c'];
// arr[1] = '!';
// console.log(arr); // выведет a ! c

//Zadacha 2 Что выведется в результате выполнения следующего кода:
// const arr = ['a', 'b', 'c'];
// arr = [1, 2, 3];
// console.log(arr); //выведет ошибку

//Zadacha 3 Что выведется в результате выполнения следующего кода:
const arr = ['a', 'b', 'c'];
arr = ['a', 'b', 'c'];
console.log(arr); //выведет ошибку